...
public class OmegaResearchActivity extends Activity {
    ...
    private void build(){
        ...
        try{raw=Files.readString(fs[0].toPath(), StandardCharsets.UTF_8);JSONObject r=new JSONObject(raw);JSONObject a=r.optJSONObject("algorithm"),c=r.optJSONObject("calibration"),s=r.optJSONObject("summary"),p=r.optJSONObject("profile");JSONArray strikes=r.optJSONArray("strikes"),frames=r.optJSONArray("frames");
