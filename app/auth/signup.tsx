  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => router.back()}>
        <Text style={styles.link}>Already have an account? <Text style={{ color: '#3B82F6' }}>Log in</Text></Text>
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: '#A3FF12', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
